...
func testTeleport() {
	...
	It("should access to boot servers via teleport ssh", func() {
		...
		*/
		...
		cookie, err := ioutil.ReadFile(filename)
		Expect(err).ShouldNot(HaveOccurred(), "cookie=%s", cookie)
		...
		#HttpOnly_10.64.0.9     FALSE   /       TRUE    0       grv_csrf        c7c59fea8ec95e81c81b285e0070cb4791e04733fa4f22dffff5a25bb5b1c4f7
		*/
